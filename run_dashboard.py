...
print(f"{BLUE}======================================{RESET}")
print(f"{BLUE}PersRM Dashboard Runner{RESET}")
print(f"{BLUE}======================================{RESET}")
print()
...
# 2. Set up environment variables for the dashboard
os.environ["PORT"] = "3018"  # Use port 3018 specifically
os.environ["NEXT_PUBLIC_APP_MODE"] = "dashboard"  # Set the app mode if needed

# 3. Start the dashboard app
print(f"{YELLOW}Starting Dashboard on port 3018...{RESET}")
try:
    ...
    print(f"{YELLOW}Server starting on port 3018... waiting{RESET}")
    for _ in range(15):  # Wait up to 15 seconds
        print(".", end="", flush=True)
        time.sleep(1)
    print("\n")
    
    # 4. Open the dashboard page in browser
    url = "http://localhost:3018/dashboard"
    print(f"{GREEN}Opening dashboard in browser: {url}{RESET}")
    webbrowser.open(url)
